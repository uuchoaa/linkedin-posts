...
class Views::Posts::WriteView < Views::Posts::Base
  def initialize(post:)
    @post = post
  end

  def page_header
    render Cuy::PageHeader.new(title: "Write Post: #{@post.title}")
      .with_action(Cuy::Button.new(variant: :secondary, href: post_path(@post)) { "Back" })
  end
  ...
  def main_content
    ...
    form_with model: @post,
      ...
      div do
        div(class: "flex justify-between items-center mb-1") do
          ...
          button(type: "button",
            ...
            svg(xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke_width: "1.5", stroke: "currentColor", class: "size-4") do |s|
      ...
      div(class: "pt-4") do
        form.submit("Save body", class: "rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700")
      end
    end
  end
end
